"""
This library provides a Python implementation of the game Isolation-Game-Playing-Agent.
Isolation-Game-Playing-Agent is a deterministic, two-player game of perfect information in
